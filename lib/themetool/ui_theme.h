...
//   ⇒ 真正空着的是"副弧之下、灯条之下"。**446** 的墨迹 = 443..456:三样全躲开,
//     且 x 方向 ±30 处仍在 240 内切圆内(240+sqrt(240²-30²)=478 > 456)。
...
inline void theme_set_defaults(Theme& t) {
  ...
  t.readout.coolant_cy    = 446;        // ★ 副弧与灯条**之下**(见上面那段:别再挪回 384)
  t.readout.intake_cy     = 446;        // 同上 —— 与水温**在各自屏上**同一行
