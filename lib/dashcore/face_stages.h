...
//   怠速 900 / 稳定巡航 2000 / 运动 4200 / 高转 5200 / 红区 6500 ——
//   每一行都是车上真会出现的那一格(5200 ≈ 2 档 95km/h 全油门;
//   6500 ≈ 断油点,待实车核对)。表盘上限是 7000,但**红区那一行不取 7000** ——
//   发动机根本到不了,模拟里点了也没有现实对应。
...
static const FaceStage kFaceStages[] = {
  ...
  {"rpm", "redline", 6500.0f, 0.0f, 85.0f, 35.0f, Face::Redline, Face::Idle},
