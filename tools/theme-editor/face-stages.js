...
(function (root, factory) {
  ...
  var FALLBACK = {
    Idle:     ["Idle", "Blink", "Cruise", "Sport"],
    Blink:    ["Blink", "Idle", "Cruise", "Sport"],
    Cruise:   ["Cruise", "Idle", "Sport", "Blink"],
    Sport:    ["Sport", "Cruise", "Redline", "Idle"],
    Redline:  ["Redline", "Sport", "Surprise", "Idle"],
    Surprise: ["Surprise", "Redline", "Sport", "Idle"],
    Cold:     ["Cold", "Idle", "Cruise", "Blink"],
  ...
  // 未被测的那两路取正常值:速度 0、水温 85、转速 900(怠速)。
  var STAGES = [
    ...
    { group: "speed",   level: "mid",  rpm: 1500, speed: 55,  coolant: 85,  face: "Cruise"   },
    { group: "speed",   level: "high", rpm: 2600, speed: 110, coolant: 85,  face: "Sport"    }
  ];
